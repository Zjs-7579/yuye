      ...
      <el-row>
        <el-col :span="6">
          <el-form-item label="省份">
            <el-input
              v-model="modernAbstract.province"
            ></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
        ...
        <el-col :span="6">
          <el-form-item label="具体地址">
            <el-input
              v-model="modernAbstract.sp_address"
            ></el-input>
          </el-form-item>
        </el-col>
      </el-row>
...
export default {
  ...
  computed: {
    ...
    modernAbstract: {
      get() {
        this.Modern.ModernData.modernAbstract['task_id'] = this.Modern.userTaskId
