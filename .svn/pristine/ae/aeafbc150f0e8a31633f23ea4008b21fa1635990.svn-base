<template>
  <div class="Moinvest">
      <el-form :model="ruleForm" ref="ruleForm" label-width="250px" class="demo-ruleForm">
        ...
        <ProjectInvestDetailed title="建筑工程类投资明细" dataForm="constructForm"></ProjectInvestDetailed>
  
        <ProjectInvestDetailed title="生产设施建设类投资明细" dataForm="effectForm"></ProjectInvestDetailed>

        <ProjectInvestDetailed title="仪器、设备类投资明细" dataForm="equipForm"></ProjectInvestDetailed>
