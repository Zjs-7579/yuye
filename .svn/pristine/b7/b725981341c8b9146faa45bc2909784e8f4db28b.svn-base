<template>
  <div class="catchFishing">
    ...
    >
      <el-row class="title"> 自捕海产品回运费 </el-row>

      <el-row>
        <el-col :span="6">
          <el-form-item label="空运冰鲜金枪鱼数量（吨）：" prop="sky_tunas_number">
            <el-input v-model="oceanSelfcapture.sky_tunas_number"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="海运超低温金枪鱼数量（吨）：" prop="sea_tunas_number">
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="已获得国家资助资金（万元）：" prop="country_cost">
  ...
  computed: {
    ...
    oceanSelfcapture: {
          get(){
              ...
              this.Fishing.OceanDeclaration.oceanSelfcapture.creator = this.Fishing.userName;
