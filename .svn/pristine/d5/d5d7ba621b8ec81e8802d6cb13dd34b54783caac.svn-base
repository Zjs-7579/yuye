  ...
  <div class="audit" v-if="this.$route.params.event == 'todo'">
      <el-form ref="ruleForm" label-width="100px" class="demo-ruleForm">
        ...
        <el-form-item label="审核结果：" >
          <el-select v-model="trial.note" placeholder="请选择审核结果" style="width: 15%">
        ...
        <el-form-item label="简单意见：" >
          <el-input v-model="trial.remark" type="textarea" rows="5" resize="none" style="width: 50%"></el-input>
        </el-form-item>
        <el-form-item label="详细意见：">
          <el-input v-model="trial.reason" type="textarea" rows="5" resize="none" style="width: 50%"></el-input>
        </el-form-item>
        <el-form-item>
...
<script>
import { flowPassSubmit, flowNotPassSubmit, flowBackSubmit } from "../../api/User/createInfo"
export default {
    data() {
        return {
            trial:{
