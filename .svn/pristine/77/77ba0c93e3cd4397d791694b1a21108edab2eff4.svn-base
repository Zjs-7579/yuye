<template>
    ...
    <el-row>
      <el-col :span="12">
        <el-form-item label="统一社会信用代码：" prop="social_code">
          <el-input
            v-model="modernCompany.social_code"
      ...
      <el-col :span="12">
        ...
        <el-form-item label="登记注册类型：" prop="regist_type">
          <el-select v-model="modernCompany.regist_type" placeholder="请选择登记注册类型" style="width: 100%">
  ...
  <el-row>
      <el-col :span="12">
        <el-form-item label="产品（服务）所属技术领域:" prop="technical_field" style="height: 122px; display: block">
          ...
          resize="none"
          rows="5"
           v-model="modernCompany.technical_field"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
  ...
  <el-form-item label="单位资质:" prop="unit_professional">
    <el-input v-model="modernCompany.unit_professional" placeholder="无此类情况则填无"></el-input>
  </el-form-item>
