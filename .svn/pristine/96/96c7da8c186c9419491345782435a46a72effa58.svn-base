<template>
	<div>
		...
		>
			...
			></el-tab-pane>
			<el-tab-pane label="单位近三年财务状况" name="InancialInfo" :disabled="isDataShow"
			...
			></el-tab-pane>
			<el-tab-pane label="国家、省、市财政近三年全部支持情况" name="HoldInfo" :disabled="isDataShow"
...
import { agriculData, agriculClearData, agriculFilesData} from "../../../utils/agriculUpData"
