export default{
    ...
    Fishing_ClearAllData(state){
        for (let item in state.OceanParam) {
            if (Object.prototype.toString.call(state.OceanParam[item]) === '[object Array]') {
          ...
          for (let item in state.OceanDeclaration) {
            ...
            if (Object.prototype.toString.call(state.OceanDeclaration[item]) === '[object String]') {
              console.log(state.OceanDeclaration[item])
                state.OceanDeclaration[item] = ""
            }
        
            if (Object.prototype.toString.call(state.OceanDeclaration[item]) === '[object Object]') {
