   ...
   <div class="box">
    ...
    <div class="dataRow">
      <el-row v-for="(item, index) in fundData" :key="index">
        <el-col :span="2"
          ><div class="grid-content bg-purple" style="text-align: center">{{ item.idx }}</div></el-col
        >
        <el-col :span="7"
          ><div class="grid-content bg-purple" style="padding-left: 2em" :class="(boldFrom.includes(index)?'boldText':'')">{{ item.title }}</div>
        </el-col>
        <el-col :span="5"
      ...
      <el-row>
        <el-col :span="9"
          ><div class="grid-content bg-purple" style="text-align: center; font-weight: bold;">合计</div></el-col
        >
        <el-col :span="5"
          ><div class="grid-content bg-purple">
            <el-input
    ...
    techFunds: {
      get() {
        ...
        for(let item in this.HighTech.HighTechData.techFunds){
          this.HighTech.HighTechData.techFunds[item]['task_id'] = this.HighTech.userTaskId
        }
    ...
    totalExpends1: {
      get() {
        ...
        for(let item in this.techFunds[0]){
          if(item != 'funds_type' && item != 'total_expendt' && item != 'total_invest' && item != 'state_funding' && item != 'city_support'){
