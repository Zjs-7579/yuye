<template>
  <div class="Moequip">
        ...
        <el-row class="titleRow">
            ...
            <el-col :span="4" style="text-align:left; text-indent: 1em;">{{total_quantity}}</el-col>
            <el-col :span="3" style="text-align:left; text-indent: 1em;">{{total_price}}</el-col>
            <el-col :span="3" style="text-align:left; text-indent: 1em;">{{total_amount}}</el-col>
