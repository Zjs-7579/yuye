...
<el-form-item label="4、项目预期经济和技术指标（销售量、营业收入、纳税额等）：" prop="index">
   <el-input
      type="textarea"
      resize="none"
      rows="10"
  ...
  <el-form-item label="5、项目社会效益（包括运行效益或预期效益，如增加就业、节约资源、促进民生等）：" prop="social_results">
    <el-input
      type="textarea"
      resize="none"
      rows="10"
...
export default {
  ...
  computed: {
    ...
    modernImplement: {
      get() {
        this.Modern.ModernData.modernImplement["task_id"] = this.Modern.userTaskId
