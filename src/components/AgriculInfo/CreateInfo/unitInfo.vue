    ...
    <el-row>
      ...
      <el-col :span="12">
        <el-form-item label="统一社会信用代码：" prop="social_code">
          <el-input
            v-model="agriculturalCompany.social_code"
    ...
    <el-row>
      <el-col :span="12"
        ><el-form-item label="所属行业：" prop="industry">
          <el-input v-model="agriculturalCompany.industry"></el-input> 
          </el-form-item
      ></el-col>
      <el-col :span="12"
      ...
      <el-col :span="12"
        ><el-form-item label="实收资本：" prop="paid_capital">
          <el-input v-model="agriculturalCompany.paid_capital"></el-input> </el-form-item
      ></el-col>
      </el-row>
      <!-- <el-row>
      <el-col :span="12">
      ...
      <el-form-item label="单位专业资质：" prop="unit_professional">
        <el-input v-model="agriculturalCompany.unit_professional" placeholder="无此类情况则填无"></el-input>
      </el-form-item>
    </el-form>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    agriculturalCompany:{
      get(){
        this.Agricul.AgriculData.agriculturalCompany['task_id'] = this.Agricul.userTaskId
