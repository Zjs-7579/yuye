...
export function modernClearData(Data) {
    for(let item in  Data.ModernData){
        if(Object.prototype.toString.call(Data.ModernData[item]) === '[object Array]'){
        ...
        if(Object.prototype.toString.call(Data.ModernData[item]) === '[object Object]'){
...
export function modernData(newData) {
    ...
    for(let item in newData){
        ...
        if(item == 'modernEquipment'){
            ...
            newData['modernInvestTotal']['project_invest'] = newData[item][0].project_invest 
