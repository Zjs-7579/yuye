...
export const ModernOther = {
	...
	bank: [
		{ required: true, message: "请输入基本账户开户行", trigger: "blur" },
	],
	account: [
	...
	com_rate: [
		{ required: true, message: "请输入建设完成率", trigger: "blur" },
	],
	eco_indi: [
		{ required: true, message: "请输入经济指标", trigger: "blur" },
	],
	other: [
...
export const ModernProjectContent = {
	...
	other_explain: [
		{ required: true, message: "请输入其他需要重点说明的情况", trigger: "blur" },
	],
};
...
export const FishingAllInfoValidator = {
	...
	legal_rpstative: [{ required: true, message: "请输入法人代表", trigger: "blur" }], //法人代表
	id_number: [{ required: true, message: "请输入身份证号", trigger: "blur" }], //身份证号
	postal_address: [{ required: true, message: "请输入通讯地址", trigger: "blur" }],//通讯地址
	contacts: [{ required: true, message: "请输入联系人", trigger: "blur" }], //联系人
	contact_number: [{ required: true, message: "请输入联系电话", trigger: "blur" }], //联系电话
	postal_code: [{ required: true, message: "请输入邮政编码", trigger: "blur" }], //邮政编码
	business_license: [{ required: true, message: "请输入营业执照", trigger: "blur" }], //营业执照
	credit_code: [{ required: true, message: "请输入社会统一信用代码", trigger: "blur" }], //社会统一信用代码
	deposit_bank: [{ required: true, message: "请输入开户银行", trigger: "blur" }], //开户银行
	account_number: [{ required: true, message: "请输入账号", trigger: "blur" }], //账号
	declare_name: [{ required: true, message: "请输入申报资助项目名称", trigger: "blur" }], //申报资助项目名称
	declare_id: [{ required: true, message: "请输入申报资助项目id", trigger: "blur" }], //申报资助项目id
	fish_base: [{ required: true, message: "请输入远洋渔业项目生产基本情况", trigger: "blur" }], //远洋渔业项目生产基本情况
	...
	build_time: [{ required: true, message: "请输入建造完工日期", trigger: "blur" }],//建造完工日期
	state_funding: [{ required: true, message: "请输入已获得国家资助资金", trigger: "blur" }],//已获得国家资助资金
	fishing_quota: [{ required: true, message: "请输入是否有入渔配额", trigger: "blur" }],//是否有入渔配额
	ship_ctfte_id: [{ required: true, message: "请输入船舶检验证书编号", trigger: "blur" }],//船舶检验证书编号
	inal_ctfte_id: [{ required: true, message: "请输入国籍证书编号", trigger: "blur" }],//国籍证书编号
	owr_ctfte_id: [{ required: true, message: "请输入所有权证书编号", trigger: "blur" }],//所有权证书编号
	completed_cost: [{ required: true, message: "请输入船舶竣工造价", trigger: "blur" }],//船舶竣工造价
	apply_cost: [{ required: true, message: "请输入申请资助资金", trigger: "blur" }],//申请资助资金


	ship_name: [{ required: true, message: "请输入船名", trigger: "blur" }],//船名
	worker_type: [{ required: true, message: "请输入作业方式", trigger: "blur" }],//作业方式
	bud_finish_time: [{ required: true, message: "请输入建造完工日期", trigger: "blur" }],//建造完工日期
	...
	owr_ctfte_id: [{ required: true, message: "请输入所有权证书编号", trigger: "blur" }],//所有权证书编号
	ship_ctfte_id: [{ required: true, message: "请输入船舶检验证书编号", trigger: "blur" }],//船舶检验证书编号
	ship_cost_id: [{ required: true, message: "请输入船舶总投资", trigger: "blur" }],//船舶总投资
	apply_cost: [{ required: true, message: "请输入申请资助资金", trigger: "blur" }],//申请资助资金
	//creator: "",//创建人


	sea_region: [{ required: true, message: "请输入远洋渔业项目作业海域", trigger: "blur" }],//远洋渔业项目作业海域
	rsous_use_cost: [{ required: true, message: "请输入已交纳境外渔业资源使用费", trigger: "blur" }],//已交纳境外渔业资源使用费
	inal_rsous_subsidy: [{ required: true, message: "请输入已获得农业部国际渔业资源开发补助", trigger: "blur" }],//已获得农业部国际渔业资源开发补助
	apply_cost: [{ required: true, message: "请输入申请资助资金", trigger: "blur" }],//申请资助资金
	//creator: "",//创建人


	sky_tunas_number: [{ required: true, message: "请输入空运冰鲜金枪鱼数量", trigger: "blur" }],//空运冰鲜金枪鱼数量
	sea_tunas_number: [{ required: true, message: "请输入海运超低温金枪鱼数量", trigger: "blur" }],//海运超低温金枪鱼数量
	other_fish_number: [{ required: true, message: "请输入其他鱼类数量", trigger: "blur" }],//其他鱼类数量
	country_cost: [{ required: true, message: "请输入已获得国家资助资金", trigger: "blur" }],//已获得国家资助资金
	appaly_cost: [{ required: true, message: "请输入申请资助资金", trigger: "blur" }],//申请资助资金
	//creator: "",//创建人

	cold_unit: [{ required: true, message: "请输入冷链物流项目地址", trigger: "blur" }],//冷链物流项目地址
	all_cold_cost: [{ required: true, message: "请输入冷链物流项目地址", trigger: "blur" }],//冷链物流项目地址--项目总投资
	low_tpte_unit: [{ required: true, message: "请输入超低温冷库地址", trigger: "blur" }],//超低温冷库地址
	all_low_cost: [{ required: true, message: "请输入超低温冷库地址", trigger: "blur" }],//超低温冷库地址--项目总投资
	abroad_unit: [{ required: true, message: "请输入境外远洋渔业基地地址", trigger: "blur" }],//境外远洋渔业基地地址
	agriculture_cost: [{ required: true, message: "请输入已获得农业部资助", trigger: "blur" }],//已获得农业部资助
	appaly_cost: [{ required: true, message: "请输入申请资助资金", trigger: "blur" }],//申请资助资金
};

export const InancialValidator = {
	business_income: [{ required: true, message: "请输入项目名称", trigger: "blur" }],
	main_business_income: [{ required: true, message: "请输入项目名称", trigger: "blur" }],
	high_tech_income: [{ required: true, message: "请输入项目名称", trigger: "blur" }],
	main_income_rate: [{ required: true, message: "请输入项目名称", trigger: "blur" }],
	total_exports: [{ required: true, message: "请输入项目名称", trigger: "blur" }],
	high_tech_exports: [{ required: true, message: "请输入项目名称", trigger: "blur" }],
	nterprise_added: [{ required: true, message: "请输入项目名称", trigger: "blur" }],
	wages: [{ required: true, message: "请输入项目名称", trigger: "blur" }],
	depreciation: [{ required: true, message: "请输入项目名称", trigger: "blur" }],
	profit: [{ required: true, message: "请输入项目名称", trigger: "blur" }],
	main_business_profit: [{ required: true, message: "请输入项目名称", trigger: "blur" }],
	main_business_rate: [{ required: true, message: "请输入项目名称", trigger: "blur" }],
	taxes_payable: [{ required: true, message: "请输入项目名称", trigger: "blur" }],
	income_tax: [{ required: true, message: "请输入项目名称", trigger: "blur" }],
	personal_tax: [{ required: true, message: "请输入项目名称", trigger: "blur" }],
	value_added_tax: [{ required: true, message: "请输入项目名称", trigger: "blur" }],
	turnover: [{ required: true, message: "请输入项目名称", trigger: "blur" }],
	other_taxes: [{ required: true, message: "请输入项目名称", trigger: "blur" }],
	actual_pref_taxes: [{ required: true, message: "请输入项目名称", trigger: "blur" }],
	income_tax_pref: [{ required: true, message: "请输入项目名称", trigger: "blur" }],
	value_added_pref: [{ required: true, message: "请输入项目名称", trigger: "blur" }],
	business_tax_pref: [{ required: true, message: "请输入项目名称", trigger: "blur" }],
	other_pref: [{ required: true, message: "请输入项目名称", trigger: "blur" }],
	total_assets: [{ required: true, message: "请输入项目名称", trigger: "blur" }],
	total_net_cash: [{ required: true, message: "请输入项目名称", trigger: "blur" }],
	total_liabilities: [{ required: true, message: "请输入项目名称", trigger: "blur" }],
	liability_ratio: [{ required: true, message: "请输入项目名称", trigger: "blur" }],
	fixed_assets: [{ required: true, message: "请输入项目名称", trigger: "blur" }],
	investment_amount: [{ required: true, message: "请输入项目名称", trigger: "blur" }],
	technology_inv: [{ required: true, message: "请输入项目名称", trigger: "blur" }],
	government_loan: [{ required: true, message: "请输入项目名称", trigger: "blur" }],
